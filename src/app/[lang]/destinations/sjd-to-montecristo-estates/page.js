...
export const landingPagesSEO = [
  ...
  { slug: 'sjd-to-montecristo-estates', nombre: 'Montecristo Estates', zona: 4, zonaText: 'Pacific Zone', tiempo: '50-60 min', dist: '50 km', image: 'montecristo-estates-airport-sjd.webp', desc: 'opulent cliffside villas' },
...
export const hotelesBase = [
  ...
  // ZONA 4: PACIFIC ZONE
  { id: 408, nombre: 'Montecristo Estates', zona: 4 },
...
export default function DestinationPage({ params }) {
  ...
  const slug = 'sjd-to-montecristo-estates';
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-2xl p-6 shadow-sm my-10">
            ...
            <div className="w-full h-72 md:h-96 rounded-xl overflow-hidden shadow-inner border border-slate-200 bg-slate-200">
              <iframe
                ...
                src={`https://maps.google.com/maps?q=${encodeURIComponent('Montecristo Estates')}&t=&z=13&ie=UTF8&iwloc=&output=embed`}
              ></iframe>
            </div>
