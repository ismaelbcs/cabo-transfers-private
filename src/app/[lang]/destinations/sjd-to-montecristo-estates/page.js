...
export default function DestinationPage({ params }) {
  ...
  const hotel = {
    "slug": "sjd-to-montecristo-estates",
    "nombre": "Montecristo Estates",
    "zona": 4,
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-2xl p-6 shadow-sm my-10">
            ...
            <div className="w-full h-72 md:h-96 rounded-xl overflow-hidden shadow-inner border border-slate-200 bg-slate-200">
              <iframe
                ...
                src={`https://maps.google.com/maps?saddr=${encodeURIComponent('Aeropuerto Internacional de Los Cabos')}&daddr=${encodeURIComponent('Montecristo Estates')}&output=embed`}
              ></iframe>
            </div>
