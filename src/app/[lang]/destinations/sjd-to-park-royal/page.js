...
export const landingPagesSEO = [
  ...
  { slug: 'sjd-to-park-royal', nombre: 'Park Royal', zona: 1, zonaText: 'San José del Cabo', tiempo: '20-25 min', dist: '15 km', image: 'park-royal-homestay-los-cabos-sjd-airport.webp', desc: 'your home away from home' },
...
export const hotelesBase = [
  ...
  { id: 114, nombre: 'Park Royal', zona: 1 },
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-2xl p-6 shadow-sm my-10">
            ...
            <div className="w-full h-72 md:h-96 rounded-xl overflow-hidden shadow-inner border border-slate-200 bg-slate-200">
              <iframe
                ...
                src={`https://maps.google.com/maps?q=${encodeURIComponent('Park Royal Los Cabos')}&t=&z=13&ie=UTF8&iwloc=&output=embed`}
              ></iframe>
            </div>
