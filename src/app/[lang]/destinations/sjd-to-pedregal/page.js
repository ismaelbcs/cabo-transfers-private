...
export const landingPagesSEO = [
  ...
  // ================= ZONA 3 =================
  { slug: 'sjd-to-pedregal', nombre: 'Pedregal', zona: 3, zonaText: 'Cabo San Lucas', tiempo: '45-50 min', dist: '44 km', image: 'sjd-to-pedregal-manor.webp', desc: 'a spectacular resort area in Cabo' },
...
export const hotelesBase = [
  ...
  { id: 9999, nombre: 'Pedregal', zona: 3 },
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-2xl p-6 shadow-sm my-10">
            ...
            <div className="w-full h-72 md:h-96 rounded-xl overflow-hidden shadow-inner border border-slate-200 bg-slate-200">
              <iframe
                ...
                src={`https://maps.google.com/maps?q=${encodeURIComponent('Pedregal Cabo San Lucas')}&t=&z=13&ie=UTF8&iwloc=&output=embed`}
              ></iframe>
            </div>
