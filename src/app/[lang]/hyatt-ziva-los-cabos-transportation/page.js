...
export async function generateMetadata({ params }) {
  ...
  if (lang === 'es') return {
    title: 'Hyatt Ziva Los Cabos Transportation | Traslados Directos',
    description: 'Reserva tu Hyatt Ziva Los Cabos Transportation. Servicio privado y directo desde el Aeropuerto SJD hasta el lobby del Hyatt Ziva en San José del Cabo.',
    keywords: 'hyatt ziva los cabos transportation, transporte hyatt ziva los cabos, SJD to hyatt ziva, traslados hyatt ziva',
  };
  return {
    title: 'Hyatt Ziva Los Cabos Transportation | Direct SJD Airport Shuttle',
    description: 'Book your Hyatt Ziva Los Cabos Transportation. Private and direct service from SJD Airport straight to the lobby of the Hyatt Ziva resort.',
    keywords: 'hyatt ziva los cabos transportation, SJD airport to hyatt ziva, hyatt ziva cabo shuttle, private transfer hyatt ziva',
  };
}
        ...
        <section className="mb-20">
          ...
          <div className="prose prose-lg text-neutral-600 prose-p:leading-relaxed max-w-none">
            ...
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-neutral-900 mb-6">
              {lang === 'es'
                ? 'Traslados Directos al Hyatt Ziva Los Cabos'
                : 'Direct Transfers to Hyatt Ziva Los Cabos'}
            </h2>
            <div className="prose prose-lg text-neutral-600 prose-p:leading-relaxed max-w-none">
              <p className="mb-6">
                {lang === 'es' ? (
                  <>Prepárate para vivir una espectacular experiencia todo incluido asegurando tu <strong>hyatt ziva los cabos transportation</strong> antes de abordar tu vuelo. Llegar a este hermoso resort de clase mundial merece un traslado que esté a la misma altura en lujo y atención.</>
                ) : (
                  <>Get ready for a spectacular all-inclusive experience by securing your <strong>hyatt ziva los cabos transportation</strong> before you even board your flight. Arriving at this beautiful, world-class resort deserves a transfer of equal luxury and care.</>
                )}
              </p>
              <p className="mb-6">
                {lang === 'es' ? (
                  <>Ubicado en el corazón de la zona hotelera de San José del Cabo, llegar es rápido y fácil con nuestro exclusivo servicio de <strong>hyatt ziva los cabos transportation</strong>. Evita las multitudes en la terminal y deja que nuestro chofer bilingüe te lleve directamente a la recepción.</>
                ) : (
                  <>Located in the heart of the San Jose del Cabo hotel zone, getting there is fast and easy with our exclusive <strong>hyatt ziva los cabos transportation</strong> service. Avoid the crowds at the terminal and let our bilingual driver take you straight to the lobby.</>
                )}
              </p>
              <p>
                {lang === 'es' ? (
                  <>Comienza a relajarte desde que sales del aeropuerto SJD. Al reservar tu <strong>hyatt ziva los cabos transportation</strong> con nosotros, te garantizamos un vehículo impecable, amplio espacio para el equipaje de toda la familia y un servicio al cliente excepcional.</>
                ) : (
                  <>Start relaxing the second you leave the SJD airport. When booking your <strong>hyatt ziva los cabos transportation</strong> with us, you are guaranteed an immaculate vehicle, ample luggage space for the whole family, and outstanding customer service.</>
                )}
              </p>
            </div>
          </div>
