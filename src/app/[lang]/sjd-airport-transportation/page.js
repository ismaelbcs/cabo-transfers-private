...
export async function generateMetadata({ params }) {
    ...
    if (lang === 'es') return {
        title: 'SJD Airport Transportation | Traslados Privados San José del Cabo',
        description: 'Reserva la mejor SJD Airport Transportation. Servicio seguro, cómodo y de lujo desde el Aeropuerto Internacional de San José del Cabo hacia tu hotel.',
        keywords: 'SJD Airport Transportation, San Jose del Cabo airport transfers, Transporte SJD Los Cabos',
    };
    return {
        title: 'Reliable SJD Airport Transportation | Los Cabos Private Shuttle',
        description: 'Book the most reliable SJD Airport Transportation. Safe, comfortable, and luxury transfers from San Jose del Cabo International Airport to your resort.',
        keywords: 'SJD Airport Transportation, SJD airport shuttle, San Jose del Cabo transfers, Airport SJD to hotel',
    };
}
                ...
                <section className="mb-20">
                    ...
                    <div className="prose prose-lg text-neutral-600 prose-p:leading-relaxed max-w-none">
                        ...
                        <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-neutral-900 mb-6">
                            {lang === 'es'
                                ? 'Transporte Confiable desde el Aeropuerto SJD'
                                : 'Reliable Transportation from SJD Airport'}
                        </h2>
                        <div className="prose prose-lg text-neutral-600 prose-p:leading-relaxed max-w-none">
                            <p className="mb-6">
                                {lang === 'es' ? (
                                    <>Comenzar tu viaje en Baja California Sur con el pie derecho es muy sencillo cuando reservas tu <strong>sjd airport transportation</strong> con anticipación. Sabemos que después de un largo vuelo, lo último que deseas es preocuparte por cómo llegar a tu hotel o lidiar con tarifas inesperadas.</>
                                ) : (
                                    <>Starting your trip in Baja California Sur on the right foot is effortless when you book your <strong>sjd airport transportation</strong> in advance. We know that after a long flight, the last thing you want is to worry about how to get to your hotel or deal with unexpected rates.</>
                                )}
                            </p>
                            <p className="mb-6">
                                {lang === 'es' ? (
                                    <>Evita el estrés de buscar transporte de último minuto. Al elegir nuestro servicio de <strong>sjd airport transportation</strong>, te garantizamos que un chofer profesional te estará esperando con un letrero personalizado, listo para ayudarte con tu equipaje desde el primer momento.</>
                                ) : (
                                    <>Avoid the stress of finding last-minute rides. By choosing our <strong>sjd airport transportation</strong> service, we guarantee a professional chauffeur will be waiting for you with a personalized sign, ready to assist with your luggage right away.</>
                                )}
                            </p>
                            <p>
                                {lang === 'es' ? (
                                    <>Relájate y disfruta del paisaje desértico y las vistas al mar. Un servicio premium de <strong>sjd airport transportation</strong> es la clave para llegar a tu resort fresco, seguro y listo para disfrutar al máximo tus vacaciones.</>
                                ) : (
                                    <>Relax and take in the desert landscape and ocean views. A premium <strong>sjd airport transportation</strong> service is the key to arriving at your resort refreshed, safe, and entirely ready to enjoy your vacation.</>
                                )}
                            </p>
                        </div>
                    </div>
