...
export async function generateMetadata({ params }) {
    ...
    if (lang === 'es') return {
        title: 'Evita las Filas de Taxis en el Aeropuerto de Cabo | SJD Transfers',
        description: 'Sáltate las filas de taxis en el aeropuerto de Cabo San Lucas. Reserva tu transporte privado VIP con anticipación y ve directo a tu hotel.',
        keywords: 'Evitar filas taxi Cabo, Skip taxi lines Cabo airport, Transporte VIP SJD',
    };
    return {
        title: 'Skip Taxi Lines at Cabo Airport | Pre-booked VIP Transfers',
        description: 'Don’t wait in the sun. Skip taxi lines at Cabo Airport by pre-booking our private VIP transportation. Meet and greet service included.',
        keywords: 'Skip taxi lines at Cabo airport, fast exit SJD airport, pre-book Cabo transportation',
    };
}
                ...
                <section className="mb-20">
                    ...
                    <div className="prose prose-lg text-neutral-600 prose-p:leading-relaxed max-w-none">
                        ...
                        <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-neutral-900 mb-6">
                            {lang === 'es'
                                ? 'Evita las Multitudes y Ve Directo a la Playa'
                                : 'Bypass the Crowds and Head Straight to the Beach'}
                        </h2>
                        <div className="prose prose-lg text-neutral-600 prose-p:leading-relaxed max-w-none">
                            <p className="mb-6">
                                {lang === 'es' ? (
                                    <>El calor del desierto y las terminales llenas de gente pueden ser agotadores. La mejor estrategia para comenzar tus vacaciones es reservar con anticipación y así poder hacer <strong>skip taxi lines at cabo airport</strong> con total tranquilidad.</>
                                ) : (
                                    <>The desert heat and crowded terminals can be exhausting. The best strategy to kick off your vacation is to pre-book your ride so you can <strong>skip taxi lines at cabo airport</strong> with complete peace of mind.</>
                                )}
                            </p>
                            <p className="mb-6">
                                {lang === 'es' ? (
                                    <>Con nuestro servicio de recibimiento, puedes hacer <strong>skip taxi lines at cabo airport</strong> fácilmente. Nuestro personal te estará esperando con un letrero personalizado, listo para escoltarte directamente a tu vehículo privado.</>
                                ) : (
                                    <>With our meet and greet service, you can easily <strong>skip taxi lines at cabo airport</strong>. Our staff will be waiting for you with a personalized sign, ready to escort you straight to your private vehicle.</>
                                )}
                            </p>
                            <p>
                                {lang === 'es' ? (
                                    <>Valora tu tiempo. Al elegir hacer <strong>skip taxi lines at cabo airport</strong>, estarás disfrutando de la piscina de tu resort mucho antes que aquellos que dejaron su transporte para el último minuto.</>
                                ) : (
                                    <>Value your time. By choosing to <strong>skip taxi lines at cabo airport</strong>, you will be enjoying your resort's pool much sooner than those who left their transportation to the last minute.</>
                                )}
                            </p>
                        </div>
                    </div>
