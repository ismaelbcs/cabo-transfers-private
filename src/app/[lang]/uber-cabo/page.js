...
export async function generateMetadata({ params }) {
  ...
  if (lang === 'es') return {
    title: 'Alternativa a Uber Cabo | Transporte Seguro en Aeropuerto SJD',
    description: '¿Pensando en usar Uber Cabo en el aeropuerto? Las regulaciones no les permiten entrar a la terminal. Evita caminar bajo el sol y reserva nuestro transporte privado legal.',
    keywords: 'uber cabo, uber en los cabos, uber aeropuerto SJD, transporte seguro cabo san lucas',
  };
  return {
    title: 'Uber Cabo Alternative | Safe & Legal SJD Airport Transfers',
    description: 'Planning to use Uber Cabo at the airport? Regulations prevent them from picking up at the terminal. Skip the long walk in the sun and book our legal, private shuttle.',
    keywords: 'uber cabo, does uber work in cabo, uber sjd airport, alternative to uber los cabos',
  };
}
        ...
        <section className="mb-20">
          ...
          <div className="prose prose-lg text-neutral-600 prose-p:leading-relaxed max-w-none">
            ...
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-neutral-900 mb-6">
              {lang === 'es'
                ? 'Traslados Seguros y sin Complicaciones'
                : 'Safe and Uncomplicated Airport Transfers'}
            </h2>
            <div className="prose prose-lg text-neutral-600 prose-p:leading-relaxed max-w-none">
              <p className="mb-6">
                {lang === 'es' ? (
                  <>Muchos viajeros consideran usar <strong>uber cabo</strong> al aterrizar, pero las estrictas regulaciones federales en el Aeropuerto de Los Cabos (SJD) a menudo dificultan o prohíben que las aplicaciones de transporte recojan pasajeros directamente en la terminal.</>
                ) : (
                  <>Many travelers consider using <strong>uber cabo</strong> upon landing, but strict federal regulations at the Los Cabos Airport (SJD) often make it difficult or illegal for rideshare apps to pick up passengers directly at the terminal.</>
                )}
              </p>
              <p className="mb-6">
                {lang === 'es' ? (
                  <>Para evitar caminar fuera de la zona del aeropuerto bajo el sol buscando tu <strong>uber cabo</strong>, nuestro servicio privado cuenta con los permisos oficiales para recibirte justo en las puertas de llegada.</>
                ) : (
                  <>To avoid dragging your luggage outside the airport zone in the sun looking for an <strong>uber cabo</strong>, our private service holds the official permits to meet you right at the arrival doors.</>
                )}
              </p>
              <p>
                {lang === 'es' ? (
                  <>Asegura tu tranquilidad. Mientras que conseguir un <strong>uber cabo</strong> puede ser incierto, nuestras espaciosas SUV reservadas con anticipación te garantizan un traslado rápido, seguro y legal a tu resort.</>
                ) : (
                  <>Secure your peace of mind. While catching an <strong>uber cabo</strong> can be uncertain, our pre-booked, spacious SUVs guarantee a fast, safe, and fully legal transfer to your resort.</>
                )}
              </p>
            </div>
          </div>
